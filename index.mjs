...
// node_modules/brotli-wasm/pkg.bundler/brotli_wasm_bg.js
...
function compress2(buf, raw_options) {
  try {
    const retptr = (void 0)(-16);
    const ptr0 = passArray8ToWasm0(buf, void 0);
    const len0 = WASM_VECTOR_LEN;
    (void 0)(retptr, ptr0, len0, addBorrowedObject(raw_options));
...
function __wbindgen_json_serialize(arg0, arg1) {
  ...
  const ptr0 = passStringToWasm0(ret, void 0, void 0);
  const len0 = WASM_VECTOR_LEN;
...
var heap, WASM_VECTOR_LEN, cachegetUint8Memory0, lTextEncoder, cachedTextEncoder, encodeString, cachegetInt32Memory0, lTextDecoder, cachedTextDecoder, heap_next, stack_pointer, BrotliStreamResult, CompressStream, DecompressStream;
var init_brotli_wasm_bg2 = __esm({
  "node_modules/brotli-wasm/pkg.bundler/brotli_wasm_bg.js"() {
    init_brotli_wasm_bg();
    ...
    stack_pointer = 32;
    BrotliStreamResult = Object.freeze({
      Init: 0,
      "0": "Init",
      ResultSuccess: 1,
      "1": "ResultSuccess",
    ...
    CompressStream = class {
      ...
      constructor(quality) {
        const ret = (void 0)(!isLikeNone(quality), isLikeNone(quality) ? 0 : quality);
        return CompressStream.__wrap(ret);
      }
      compress(input_opt, output_size) {
        try {
          const retptr = (void 0)(-16);
          var ptr0 = isLikeNone(input_opt) ? 0 : passArray8ToWasm0(input_opt, void 0);
          var len0 = WASM_VECTOR_LEN;
          (void 0)(retptr, this.ptr, ptr0, len0, output_size);
          var r0 = getInt32Memory0()[retptr / 4 + 0];
          var r1 = getInt32Memory0()[retptr / 4 + 1];
          var r2 = getInt32Memory0()[retptr / 4 + 2];
          var r3 = getInt32Memory0()[retptr / 4 + 3];
    ...
    DecompressStream = class {
      ...
      decompress(input, output_size) {
        try {
          const retptr = (void 0)(-16);
          const ptr0 = passArray8ToWasm0(input, void 0);
          const len0 = WASM_VECTOR_LEN;
          (void 0)(retptr, this.ptr, ptr0, len0, output_size);
          var r0 = getInt32Memory0()[retptr / 4 + 0];
          var r1 = getInt32Memory0()[retptr / 4 + 1];
...
// node_modules/brotli-wasm/pkg.bundler/brotli_wasm.js
...
var init_brotli_wasm = __esm({
  "node_modules/brotli-wasm/pkg.bundler/brotli_wasm.js"() {
    init_brotli_wasm_bg();
    init_brotli_wasm_bg2();
  }
});

// node_modules/brotli-wasm/index.browser.js
var require_index_browser = __commonJS({
  "node_modules/brotli-wasm/index.browser.js"(exports, module2) {
    module2.exports = Promise.resolve().then(() => (init_brotli_wasm(), brotli_wasm_exports));
  }
});
